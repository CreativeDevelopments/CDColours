...
const colour = (text: string, {textColour = 'none', backgroundColour = 'none'}): string | void => {
        ...
        if (textColour == 'none' && backgroundColour == 'none') { return console.error("\x1b[36mCDColours \x1b[34m>> \x1b[37mNo colours were specified, try \x1b[1mcolour('Hello World!', { textColour: 'blue', backgroundColour: 'green' }) \x1b[0minstead") }
